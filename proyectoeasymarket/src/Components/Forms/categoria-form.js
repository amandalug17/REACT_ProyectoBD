...
export class CategoriaForm extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (nombre === ''){
            ...
            axios.post(`http://127.0.0.1:8000/categorias/`, this.state,
            {
                headers: {"Access-Control-Allow-Origin": "*"}
            });
            const allInfo = `Ha agregado con exito la ciudad`;
            alert(allInfo)
            window.location.replace("http://localhost:3000/create/producto")
        }
